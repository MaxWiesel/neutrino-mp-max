...
AC_ARG_WITH(boxtype,
	AS_HELP_STRING([--with-boxtype], [valid values: generic, azbox, tripledragon, spark, duckbox, coolstream, armbox, mipsbox]),
	[case "${withval}" in
		generic|azbox|tripledragon|spark|duckbox|coolstream|armbox|mipsbox)
			BOXTYPE="$withval"
		;;
		*)
...
AS_HELP_STRING([], [valid for armbox: hd51, hd60, bre2ze4k, osmio4k, osmio4kplus, vusolo4k, vuduo4k, vuultimo4k, vuuno4k, vuuno4kse, vuzero4k, zgemmah7])
AS_HELP_STRING([], [valid for mipsbox: vuduo]),
	[case "${withval}" in
		...
		;;
		hd51|hd60|bre2ze4k|osmio4k|osmio4kplus|vusolo4k|vuduo4k|vuultimo4k|vuuno4k|vuuno4kse|vuzero4k|zgemmah7)
...
case "$BOXMODEL" in
	hd2|hd51|hd60|bre2ze4k|osmio4k|osmio4kplus|vusolo4k|vuduo4k|vuultimo4k|vuuno4k|vuuno4kse|vuzero4k|vuduo|zgemmah7)
		AC_DEFINE(ENABLE_CHANGE_OSD_RESOLUTION, 1, [enable to change osd resolution])
	;;
esac
])
