...
AS_HELP_STRING([], [valid for armbox: hd51, hd60, bre2ze4k, osmio4k, osmio4kplus, vusolo4k, vuduo4k, vuultimo4k, vuzero4k])
AS_HELP_STRING([], [valid for mipsbox: vuduo]),
	[case "${withval}" in
		...
		;;
		hd51|hd60|bre2ze4k|osmio4k|osmio4kplus|vusolo4k|vuduo4k|vuultimo4k|vuzero4k)
