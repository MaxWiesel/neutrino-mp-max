...
int CLCD4lSetup::show()
{
	...
	mc = new CMenuOptionChooser(LOCALE_LCD4L_WEATHER, &fake_lcd4l_weather, OPTIONS_OFF0_ON1_OPTIONS, OPTIONS_OFF0_ON1_OPTION_COUNT, (file_exists( DATADIR "/lcd/scripts/weather")), lcd_weather, CRCInput::convertDigitToKey(shortcut++));
	...
	mc = new CMenuOptionChooser(LOCALE_LCD4L_CLOCK_A, &fake_lcd4l_clock_a, OPTIONS_OFF0_ON1_OPTIONS, OPTIONS_OFF0_ON1_OPTION_COUNT, (file_exists( DATADIR "/lcd/scripts/aclock")), lcd_clock_a, CRCInput::convertDigitToKey(shortcut++));
