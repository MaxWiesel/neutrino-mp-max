...
{
	t.glcd_color_fg_red = configfile.getInt32("glcd_color_fg_red", 0x64);
	t.glcd_color_fg_green = configfile.getInt32("glcd_color_fg_green", 0x64);
	t.glcd_color_fg_blue = configfile.getInt32("glcd_color_fg_blue", 0x64);
	...
	t.glcd_show_time = configfile.getBool("glcd_show_time", true);
	t.glcd_show_weather = configfile.getBool("glcd_show_weather", false);
	t.glcd_align_channel = configfile.getInt32("glcd_align_channel", 2);
	t.glcd_align_epg = configfile.getInt32("glcd_align_epg", 2);
	...
	t.glcd_align_time = configfile.getInt32("glcd_align_time", 2);
	t.glcd_percent_channel = configfile.getInt32("glcd_percent_channel", 25);
	t.glcd_channel_x_position = configfile.getInt32("glcd_channel_x_position", 0);
	t.glcd_channel_y_position = configfile.getInt32("glcd_channel_y_position", 25);
	t.glcd_percent_epg = configfile.getInt32("glcd_percent_epg", 15);
	t.glcd_epg_x_position = configfile.getInt32("glcd_epg_x_position", 0);
	t.glcd_epg_y_position = configfile.getInt32("glcd_epg_y_position", 100);
	...
	t.glcd_percent_time = configfile.getInt32("glcd_percent_time", 25);
	t.glcd_time_x_position = configfile.getInt32("glcd_time_x_position", 0);
	t.glcd_time_y_position = configfile.getInt32("glcd_time_y_position", 175);
	t.glcd_percent_bar = configfile.getInt32("glcd_percent_bar", 20);
	t.glcd_bar_x_position = configfile.getInt32("glcd_bar_x_position", 0);
	t.glcd_bar_y_position = configfile.getInt32("glcd_bar_y_position", 155);
	t.glcd_bar_width = configfile.getInt32("glcd_bar_width", 315);
	t.glcd_percent_logo = configfile.getInt32("glcd_percent_logo", 25);
	t.glcd_logo_x_position = configfile.getInt32("glcd_logo_x_position", 0);
	t.glcd_logo_y_position = configfile.getInt32("glcd_logo_y_position", 25);
	t.glcd_percent_smalltext = configfile.getInt32("glcd_percent_smalltext", 4);
	t.glcd_smalltext_y_position = configfile.getInt32("glcd_smalltext_y_position", 6);
	t.glcd_rec_icon_x_position = configfile.getInt32("glcd_rec_icon_x_position", 200);
	t.glcd_mute_icon_x_position = configfile.getInt32("glcd_mute_icon_x_position", 150);
	t.glcd_ts_icon_x_position = configfile.getInt32("glcd_ts_icon_x_position", 295);
	t.glcd_timer_icon_x_position = configfile.getInt32("glcd_timer_icon_x_position", 240);
	t.glcd_ecm_icon_x_position = configfile.getInt32("glcd_ecm_icon_x_position", 5);
	t.glcd_dd_icon_x_position = configfile.getInt32("glcd_dd_icon_x_position", 120);
	t.glcd_txt_icon_x_position = configfile.getInt32("glcd_txt_icon_x_position", 85);
	t.glcd_cam_icon_x_position = configfile.getInt32("glcd_cam_icon_x_position", 45);
	t.glcd_digital_clock_y_position = configfile.getInt32("glcd_digital_clock_y_position", 20);
	t.glcd_size_simple_clock = configfile.getInt32("glcd_size_simple_clock", 40);
	t.glcd_simple_clock_y_position = configfile.getInt32("glcd_simple_clock_y_position", 20);
	...
	t.glcd_weather_x_position_current_standby = configfile.getInt32("glcd_weather_x_position_current_standby", 10);
	t.glcd_weather_x_position_next_standby = configfile.getInt32("glcd_weather_x_position_next_standby", 340);
	t.glcd_weather_y_position_standby = configfile.getInt32("glcd_weather_y_position_standby", 175);
